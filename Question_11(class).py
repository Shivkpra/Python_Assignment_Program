...
class Farm:                                                                 #creating class
  def __init__(self,ch_num,co_num,pi_num):                                  #Construtor
      self.ch_num=ch_num
      self.co_num=co_num
      self.pi_num=pi_num

  def total_legs( self,ch, co, pi):                                        #functiom declaration
      ch_legs = ch_num * 2
      co_legs = co_num * 4
      pi_legs = pi_num * 4
      total_leg = ch_legs + co_legs + pi_legs                             #calculate total number of leg in farm
      return total_leg
...
obj=Farm(ch_num,co_num,pi_num)                                            #creating object 
